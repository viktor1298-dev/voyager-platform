...
export function ThemeToggle() {
  ...
  return (
    <button
      ...
      className="h-11 w-11 rounded-xl border border-[var(--color-border)] hover:border-[var(--color-border-hover)] bg-[var(--glass-bg)] hover:bg-[var(--color-bg-card-hover)] flex items-center justify-center transition-all duration-200"
    >
