DO $$ BEGIN
 CREATE TYPE "public"."cluster_provider" AS ENUM('kubeconfig', 'aws-eks', 'azure-aks', 'google-gke', 'minikube');
EXCEPTION
...
ALTER TABLE "clusters" ALTER COLUMN "provider" TYPE "cluster_provider" USING (
  CASE
    ...
    WHEN "provider" IN ('gcp', 'gke', 'google-gke') THEN 'google-gke'::"cluster_provider"
